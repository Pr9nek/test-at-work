...
export default function EditUser() {
  ...
  const onSubmit = (values: FormValues, userId: number) => {
    upsertEditedUser({
      id: userId,
      name: values.name,
    ...
    <div className={styles.container}>
          ...
          {(user: ApiUser) => {
            ...
            return (
              <>
                ...
                <form onSubmit={handleSubmit((vals) => onSubmit(vals, user.id))} className={styles.form}>
                  ...
                  <div className={styles.formRow}>
                    ...
                    <div className={styles.formField}>
                      ...
                      />
                      {errors.companyName && <span className={styles.errorMessage}>{errors.companyName.message}</span>}
                    </div>
                  </div>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <h3 style={{ margin: 0, fontSize: 18, fontWeight: 600 }}>Изменения сохранены</h3>
          <button 
        ...
        <p style={{ margin: 0, color: '#6b7280' }}>Данные пользователя обновлены.</p>
      </Modal>
    </div>
  );
}
